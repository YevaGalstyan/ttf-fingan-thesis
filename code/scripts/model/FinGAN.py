# Modified from the Fin-GAN reference implementation by Vuletić, Prenzel and
# Cucuringu (https://github.com/milenavuletic/Fin-GAN), August 2026.
#
# Change: TrainLoopForGAN — added the missing gen_loss.backward() call, so that
# the generator receives a gradient. The fifteen other training loops in this
# file already include it.
